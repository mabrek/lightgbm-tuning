...
if __name__ == "__main__":
    parameter_space = {
        ...
        'min_data_in_bin': randint(1, 100),
        'bin_construct_sample_cnt': randint(5000, 10000),
    }
